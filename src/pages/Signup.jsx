        ...
        <div className="flex items-center gap-2 mb-8">
          {[1, 2].map((s) => (
            <div key={s} className="flex items-center gap-2">
              ...
              <span
                className={`text-xs ${s === step ? "text-blue-600 font-medium" : "text-gray-400"}`}
              >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 mt-2">
            ...
            <div className="flex gap-3 mt-2">
              <button
                onClick={() => setStep(1)}
                className="border border-gray-300 text-gray-600 py-3 px-6 rounded-xl font-medium text-sm hover:bg-gray-50 transition-colors whitespace-nowrap"
              >
                ← Back
              </button>
              <button
                ...
                disabled={loading}
                className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white py-3 px-2 rounded-xl font-medium text-sm transition-colors"
              >
